...
[_COLEMAKDH] = LAYOUT(
        ...
        KC_LGUI,  KC_Z,   KC_X,    KC_C,    KC_D,    KC_V, KC_MUTE,      UG_TOGG, KC_K,    KC_H, KC_COMM,  KC_DOT, KC_SLSH,  KC_INS,
                  KC_LALT,KC_LCTL,KC_LSHIFT_CAPS,MO(1), KC_SPC,     KC_ENT,  MO(2), KC_RSHIFT_CAPS, KC_RCTL, KC_RALT
),
/* SYMBOL
 * ,-----------------------------------------.                    ,-----------------------------------------.
