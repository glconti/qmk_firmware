...
[_COLEMAKDH] = LAYOUT(
 ...
 LT(_NUMPAD, KC_TAB), KC_A,   KC_R,    KC_S,    KC_T,    KC_G,           KC_M,    KC_N,    KC_E,    KC_I,    KC_O,  KC_QUOT,
        KC_LGUI,  KC_Z,   KC_X,    KC_C,    KC_D,    KC_V, KC_MUTE,      XXXXXXX, KC_K,    KC_H, KC_COMM,  KC_DOT, KC_SLSH,  KC_INS,
                  KC_LALT,KC_LCTL,TD(TD_LSHIFT_CAPS),MO(1), KC_SPC,     KC_ENT,  MO(2), TD(TD_RSHIFT_CAPS), KC_RCTL, KC_RALT
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
